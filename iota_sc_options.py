...
opts.add("macroparticles", 10240, "number of macro particles")
...
opts.add("collective", None, "space charge [off|2d-openhockney|2d-bassetti-erskine|3d-openhockney", str)
...
job_mgr = synergia_workflow.Job_manager("iota_sc.py", opts, ["machine.seq"])
